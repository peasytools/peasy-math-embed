...
[![npm](https://img.shields.io/npm/v/peasy-math-embed)](https://www.npmjs.com/package/peasy-math-embed)
[![License: MIT](https://img.shields.io/badge/License-MIT-blue.svg)](https://opensource.org/licenses/MIT)
[![Zero Dependencies](https://img.shields.io/badge/dependencies-0-brightgreen)](https://www.npmjs.com/package/peasy-math-embed)
[![Size](https://img.shields.io/badge/gzipped-<8KB-green)](https://bundlephobia.com/package/peasy-math-embed)

Embed **PeasyMath** widgets on any website or blog. Math tools — calculators, converters, graphing, and number utilities. Each widget is completely isolated via **Shadow DOM**, requires **zero dependencies**, and supports **3 built-in themes** (light, dark, sepia). The self-executing script finds all `data-peasy-math` elements on the page and renders interactive widgets automatically, including support for dynamically added elements in single-page applications via MutationObserver.

PeasyMath is part of the [Peasy Tools](https://peasytools.com) ecosystem, providing 11 widget types for embedding file format information, tool cards, conversion guides, glossary terms, search boxes, and interactive tools directly into your pages.

> **Try the interactive widget builder at [widget.peasymath.com](https://widget.peasymath.com)** -- build, preview, and copy embed code for any widget type.

<p align="center">
  <img src="demo.gif" alt="peasy-math-embed demo -- embed peasymath widgets with Shadow DOM isolation and theme support" width="800">
</p>
...
<div data-peasy-math="tool"
  data-slug="unit-converter"
  data-theme="light">
</div>
...
That's it. The script will find all `data-peasy-math` elements, fetch data from the PeasyMath API, and render each widget with full Shadow DOM style isolation.

## Widget Types

PeasyMath supports 11 widget types -- 11 common types available on all Peasy sites.

| Type | Description | Usage |
|------|-------------|-------|
| `format` | File format info card with specs, MIME type, and use cases | `<div data-peasy-math="format" data-slug="..."></div>` |
| `tool` | Tool card with description and direct launch link | `<div data-peasy-math="tool" data-slug="..."></div>` |
| `convert` | Conversion card showing input/output format pair | `<div data-peasy-math="convert" data-slug="..."></div>` |
| `compare` | Side-by-side comparison of two formats or tools | `<div data-peasy-math="compare" data-slug="..."></div>` |
| `glossary` | Glossary term tooltip with definition on hover | `<div data-peasy-math="glossary" data-slug="..."></div>` |
| `gallery` | Grid gallery of available tools for a category | `<div data-peasy-math="gallery" data-slug="..."></div>` |
| `guide` | Guide/tutorial card with summary and read-more link | `<div data-peasy-math="guide" data-slug="..."></div>` |
| `usecase` | Use-case card showing when and why to use a tool | `<div data-peasy-math="usecase" data-slug="..."></div>` |
| `badge` | Inline badge showing format type or tool category | `<div data-peasy-math="badge" data-slug="..."></div>` |
| `search` | Search box with autocomplete for tools and formats | `<div data-peasy-math="search" data-slug="..."></div>` |
| `interactive` | Embedded interactive tool via iframe | `<div data-peasy-math="interactive" data-slug="..."></div>` |
...
|-----------|--------|---------|-------------|
| `data-peasy-math` | format, tool, convert, compare, glossary, gallery, guide, usecase, badge, search, interactive | *required* | Widget type to render |
...
<div data-peasy-math="tool" data-slug="unit-converter" data-theme="light"></div>

<!-- Dark theme -- dark background, light text -->
<div data-peasy-math="tool" data-slug="unit-converter" data-theme="dark"></div>

<!-- Sepia theme -- warm, paper-like appearance -->
<div data-peasy-math="tool" data-slug="unit-converter" data-theme="sepia"></div>

<!-- Auto theme -- follows prefers-color-scheme -->
<div data-peasy-math="tool" data-slug="unit-converter" data-theme="auto"></div>
```

Each theme sets CSS custom properties inside the Shadow DOM. The accent color (`#14B8A6`) is consistent across all themes, providing brand recognition for PeasyMath.
...
```html
<script type="module">
  import 'https://cdn.jsdelivr.net/npm/peasy-math-embed@1/dist/embed.esm.js';
</script>
```
...
```html
<!-- PeasyMath format info card with light theme -->
<div data-peasy-math="format" data-slug="unit-converter" data-theme="light"></div>
<script src="https://cdn.jsdelivr.net/npm/peasy-math-embed@1/dist/embed.min.js"></script>
```
...
```html
<!-- Search across PeasyMath tools and formats -->
<div data-peasy-math="search"
  data-placeholder="Search PeasyMath tools..."
  data-theme="light">
</div>
<script src="https://cdn.jsdelivr.net/npm/peasy-math-embed@1/dist/embed.min.js"></script>
```
...
```html
<p>This file is in <div data-peasy-math="badge" data-slug="unit-converter"></div> format.</p>
<script src="https://cdn.jsdelivr.net/npm/peasy-math-embed@1/dist/embed.min.js"></script>
```
...
```html
<!-- Embed an interactive PeasyMath tool -->
<div data-peasy-math="interactive"
  data-slug="math/example-tool"
  data-height="500"
  data-theme="light">
</div>
<script src="https://cdn.jsdelivr.net/npm/peasy-math-embed@1/dist/embed.min.js"></script>
...
> **Note:** The `data-slug` value uses the format `category-slug/tool-slug`. Find available tools at [peasymath.com/api/v1/tools/](https://peasymath.com/api/v1/tools/).
...
```html
<div data-peasy-math="glossary" data-slug="lossless" data-theme="light"></div>
<script src="https://cdn.jsdelivr.net/npm/peasy-math-embed@1/dist/embed.min.js"></script>
```
...
- **CORS**: PeasyMath API has CORS enabled for all origins
...
- **Powered by**: Each widget includes a subtle "PeasyMath" backlink in the footer

## Learn More

Visit [peasymath.com](https://peasymath.com) for the full PeasyMath experience.

- **All Tools**: [peasymath.com](https://peasymath.com)
- **Formats**: [peasymath.com/formats/](https://peasymath.com/formats/)
- **Glossary**: [peasymath.com/glossary/](https://peasymath.com/glossary/)
- **Guides**: [peasymath.com/guides/](https://peasymath.com/guides/)
- **API Documentation**: [peasymath.com/developers/](https://peasymath.com/developers/)
- **OpenAPI Spec**: [peasymath.com/api/openapi.json](https://peasymath.com/api/openapi.json)
- **Widget Builder**: [widget.peasymath.com](https://widget.peasymath.com)
- **npm Package**: [npmjs.com/package/peasy-math-embed](https://www.npmjs.com/package/peasy-math-embed)
